...
for k=1:numFrames %Loop that goes through each frame
    ...
    [centers, radii] = imfindcircles(bw(:,:,k),[10 20]);
    ...
    for a=1:y(k)
        ...
        %edge
        if whichBand>1 && (sqrt((201-centersCell{k}(a,1)+radiiCell{k}(a))^2+ ...
                (201-centersCell{k}(a,2)+radiiCell{k}(a))^2)<=r-100 ... 
                || sqrt((201-centersCell{k}(a,1)+radiiCell{k}(a))^2+ ...
                (201-centersCell{k}(a,2)-radiiCell{k}(a))^2)<=r-100 ...
                || sqrt((201-centersCell{k}(a,1)-radiiCell{k}(a))^2+ ... 
                (201-centersCell{k}(a,2)+radiiCell{k}(a))^2)<=r-100 ...
                || sqrt((201-centersCell{k}(a,1)-radiiCell{k}(a))^2+ ...
            ...
            cellOnInnerEdge{k}(c)= struct('Center',centersCell{k}(a,:), ...
                'Radii',radiiCell{k}(a)); 
            %counter
            c= c+1;
        ...
        elseif (sqrt((201-centersCell{k}(a,1)+radiiCell{k}(a))^2+ ...
                (201-centersCell{k}(a,2)+radiiCell{k}(a))^2)>=r ... 
                || sqrt((201-centersCell{k}(a,1)+radiiCell{k}(a))^2+ ...
                (201-centersCell{k}(a,2)-radiiCell{k}(a))^2)>=r ...
                || sqrt((201-centersCell{k}(a,1)-radiiCell{k}(a))^2+ ... 
                (201-centersCell{k}(a,2)+radiiCell{k}(a))^2)>=r ...
            ...
            cellOnOuterEdge{k}(d)= struct('Center',centersCell{k}(a,:), ...
                'Radii',radiiCell{k}(a)); 
            %counter
            d= d+1;
        end
    ...
    if k>1 && innerBound(k)>1
        ...
        for b=1:innerBound(k)
            ...
            for a=1:y(k-1)
                ...
                newDist= sqrt((cellOnInnerEdge{k}{b}.Center(1)- ...
                    centersCell{k-1}(a,1))^2+ ...
                    (cellOnInnerEdge{k}{b}.Center(2)- ...
                    centersCell{k-1}(a,2))^2);
            ...
            if sqrt((201-cellOnInnerEdge{k}{b}.Center(1))^2 ...
                    +(201-cellOnInnerEdge{k}{b}.Center(2))^2)< ...
                    sqrt((201-centersCell{k-1}(bact,1))^2+ ...
                    (201-centersCell{k-1}(bact,2))^2)
...
for k= 1:numFrames
    ...
    if k>1 && outerBound(k)>1
        ...
        for b= 1:outerBound(k)
            ...
            %previous cell
            if sqrt((201-cellOnOuterEdge{k}{b}.Center(1))^2 ...
                    +(201-cellOnOuterEdge{k}{b}.Center(2))^2)> ...
                    sqrt((201-centersCell{k-1}(bact,1))^2+ ...
                    (201-centersCell{k-1}(bact,2))^2)
    ...
    if k<numFrames && outerBound(k)>1
        ...
        for b=1:outerBound(k)
            ...
            for a=1:y(k+1)
                %finding distance between two centroids
                newDist= sqrt((cellOnOuterEdge{k}{b}.Center(1)- ...
                    centersCell{k+1}(a,1))^2+ ...
                    (cellOnOuterEdge{k}{b}.Center(2)- ...
                    centersCell{k+1}(a,2))^2);
